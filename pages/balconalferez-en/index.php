...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <meta name="viewport" content="width=device-width">
         ...
         <meta name="keywords" content="xalapa, hotel, hotels, rooms, rent, rates, hostel, méxico, veracruz, hoteles, hostal, habitaciones, turismo, actividades, viaje, centro, paseos, ventas, tarifas, restaurante, desayunos, camas, reservas, reservaciones, habitación, comidas, conocer"/>
    ...
    <body id="pages" class="balcon english">
        <!--[if lt IE 8]>
        	...
        	<div id="header-wrapper">
			    ...
			    <nav id="menu-primary">  
			        ...
			        <ul class="menu-1">
			            ...
			            <li><a class="active" href="/pages/balconalferez-en/">Balcón del Alférez</a><span>k</span></li>
		        ...
		        <div id="menu-secundary">
			        ...
			        <div id="menu-content">
				        <ul class="menu">
					        ...
					        <li><a target="_blank" href="https://reservations.easy-rez.com/be/?token=c4968ecee67d109732fda0b8b837573b&ln=en" class="<?php if ($page_id == 5) { ?>active<? } ?>">Reservations</a></li>

				        </ul>
				        
				        <ul class="menu-lang">
				        	<li class="lang"><a title="Español" class="es " href="/pages/balconalferez-es/">ES</a></li>
						    <li class="lang"><a title="English" class="en active" href="/pages/balconalferez-en/">EN</a></li>
						</ul>
        ...
        <footer id="footer-pages">
	        ...
	        <div id="footer-content">
	        	...
	        	<div class="col-left">
		        	...
		        	Phones: (228) 8180113 - 818 6351 / Email: <span>balcon@pradodelrio.com </span></p>
	        	</div>
        ...
        <script>
            var _gaq=[['_setAccount','UA-38934991-11'],['_trackPageview']];
