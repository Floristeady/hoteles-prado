...
$pages[4] = array("template" => "acerca-coatepec");
...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>Hotel Mesón del Alférez Coapetec</title>
        <meta name="description" content="">
        <meta name="viewport" content="width=device-width">
        
         <!-- SEO Meta tags -->
         <meta name="description" content="Hotel Mesón de Alférez Coatepec | Hoteles Prado del río"/>
         <meta name="keywords" content="coatepec, xalapa, hotel, méxico, veracruz, hoteles, hostal, habitaciones, turismo, actividades, viaje, centro, paseos, ventas, tarifas, restaurante, desayunos, camas, reservas, reservaciones, habitación, comidas, conocer"/>
    ...
    <body id="pages" class="meson-coa">
			    ...
			    <nav id="menu-primary">  
			        ...
			        <ul class="menu-1">
			            ...
			            <li><a href="/pages/posadacafeto-es/">Posada del Cafeto</a><span>k</span></li>
			             <li class="coa"><a  class="active" href="/pages/mesonalferez-coatepec-es/">Mesón del Alférez Coatepec</a><span>k</span></li>
		        ...
		        <div id="menu-secundary">
			        ...
			        <div id="menu-content">
				        <ul class="menu">
					        ...
					        <li><a href="?page_id=4" class="<?php if ($page_id == 4) { ?>active<? } ?>" >Acerca de Coatepec</a></li>
					        <li><a target="_blank" href="https://reservations.easy-rez.com/be/?token=70965714cde9becba18c420d27c08054&ln=es " class="<?php if ($page_id == 5) { ?>active<? } ?>">Reservaciones</a></li>

				        </ul>
				        
				        <ul class="menu-lang">
				        	<li class="lang"><a title="Español" class="es active" href="/pages/mesonalferez-coatepec-es/">ES</a></li>
						    <li class="lang"><a title="English" class="en" href="/pages/mesonalferez-coatepec-en/">EN</a></li>
						</ul>
        ...
        <footer id="footer-pages">
	        ...
	        <div id="footer-content">
	        	...
	        	<div class="col-left">
		        	<p><strong>Mesón del Alférez Coatepec</strong><br/>
		        	Jiménez del Campillo No.47, centro, Coatepec, Ver.  México.<br/>
		        	Teléfono: (228) 816 6744 - 816 8471 / Correo Electrónico: <span>alferezcoatepec@pradodelrio.com  </span></p>
	        	</div>
	        	
	        	<div class="col-right">
		        	<h4>Visítanos en:</h4>
		        	<ul>
			        	<li><a target="_blank" href="http://www.facebook.com/meson.delalferezcoatepec">> Facebook</a></li>
			        	<li><a target="_blank" href="https://twitter.com/AlferezCoatepec">> Twitter</a></li>
			        	<li><a target="_blank" href="http://www.tripadvisor.com.mx/Hotel_Review-g667449-d551424-Reviews-Meson_del_Alferez_Coatepec-Coatepec_Central_Mexico_and_Gulf_Coast.html ">> TripAdvisor</a></li>
        ...
        <script>
            var _gaq=[['_setAccount','UA-38934991-4'],['_trackPageview']];
