...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <meta name="viewport" content="width=device-width">
         ...
         <meta name="keywords" content="xalapa, hotels, booking, rooms, bed, breakfast, travel, center, holidays, hotel, méxico, veracruz, hoteles, hostal, habitaciones, turismo, actividades, viaje, centro, paseos, ventas, tarifas, restaurante, desayunos, camas, reservas, reservaciones, habitación, comidas, conocer"/>
    ...
    <body id="pages" class="meson-xlp english">
        <!--[if lt IE 8]>
        	...
        	<div id="header-wrapper">
			    ...
			    <nav id="menu-primary">  
			        ...
			        <ul class="menu-1">
			            ...
			            <li><a class="active" href="/pages/mesonalferez-xalapa-en/">Mesón del Alférez Xalapa</a><span>k</span></li>
		        ...
		        <div id="menu-secundary">
			        ...
			        <div id="menu-content">
				        <ul class="menu">
					        ...
					        <li><a target="_blank" href="https://reservations.easy-rez.com/be/?token=d66a1c737af6627e3d55e5b64ec4749a&ln=en" class="<?php if ($page_id == 5) { ?>active<? } ?>">Reservations</a></li>

				        </ul>
				        
				        <ul class="menu-lang">
				        	<li class="lang"><a title="Español" class="es" href="/pages/mesonalferez-xalapa-es/">ES</a></li>
						    <li class="lang"><a title="English" class="en active" href="/pages/mesonalferez-xalapa-en/">EN</a></li>
						</ul>
        ...
        <script type="text/javascript">
		  ...
		  var _gaq = _gaq || [];
		  _gaq.push(['_setAccount', 'UA-38934991-3']);
