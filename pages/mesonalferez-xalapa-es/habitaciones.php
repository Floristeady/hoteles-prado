<div id="page-inner">
	<div id="main-img">
		<div class="img-content">
			<div class="text"><h2><span class="line-white-2 f-left"></span>Habitaciones<span class="line-white-2 f-right"></span></h2></div>
			<img src="../../img/mesonxlp/imghabita.jpg" alt="imghabita" />
		</div>
	</div>
	...
	<div id="content">
		...
		<div class="subcontent">
			...
			<div id="bread">
				<a href="/">Inicio</a><span> ></span> <a href="?page_id=0">Mesón del Alférez Xalapa</a> <span>></span> <p>Habitaciones</p>
			</div>
			
			<h1 class="title">Habitaciones</h1>
			<h2 class="subtitle">El hotel cuenta con 16 habitaciones.</h2>
			...
			<div class="room">
				...
				<div class="col-right">
					<img src="../../img/mesonxlp/habita01.jpg" alt="Habitación Sencilla" />
				</div>
			...
			<div class="room">
				...
				<div class="col-right">
					<img src="../../img/mesonxlp/habita02.jpg" alt="Habitación Suite"/>
				</div>
