...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <body id="pages" class="posada">
        	...
        	<div id="header-wrapper">
			    ...
			    <nav id="menu-primary">  
			        ...
			        <ul class="menu-1">
			            ...
			            <li><a class="active" href="/pages/posadacafeto-es/">Posada del Cafeto</a><span>k</span></li>
		        ...
		        <div id="menu-secundary">
			        ...
			        <div id="menu-content">
				        <ul class="menu">
					        ...
					        <li><a target="_blank" href="https://reservations.easy-rez.com/be/?token=2b4bee26699e48b9d54ee3177bc66121&ln=es" class="<?php if ($page_id == 5) { ?>active<? } ?>">Reservaciones</a></li>

				        </ul>
				        
				        <ul class="menu-lang">
				        	<li class="lang"><a title="Español" class="es active" href="/pages/posadacafeto-es/">ES</a></li>
						    <li class="lang"><a title="English" class="en" href="/pages/posadacafeto-en/">EN</a></li>
						</ul>
        ...
        <footer id="footer-pages">
	        ...
	        <div id="footer-content">
	        	...
	        	<div class="col-left">
		        	...
		        	Teléfonos: (228) 817 0023 - 812 0403 / Correo Electrónico: <span>cafeto@pradodelrio.com</span></p>
	        	</div>
        ...
        <script>
            var _gaq=[['_setAccount','UA-38934991-6'],['_trackPageview']];
